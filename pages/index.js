      ...
      <Box bg="gray.100" py={16}>
        <Flex as="main" direction="column" maxW="700px" margin="0 auto">
          ...
          <Text mb={4} fontSize="lg" py={4}>
            ...
            {`. It's the easiest way to add comments or reviews to your static site. It's still a work-in-progress, but you can try it out by logging in. Just one line of code, which makes you going like on 🔥`}
          </Text>
          {auth.user ? (
            <Button
              as="a"
